...
- (void) loadView {
	...
	UINavigationItem				*navItem = [[[UINavigationItem alloc] initWithTitle: NSLocalizedString(@"twitterLogin", nil)] autorelease];
	...
	[navItem setLeftBarButtonItem:cancelBarButtonItem];
